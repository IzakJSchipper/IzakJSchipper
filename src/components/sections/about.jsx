        ...
        <RevealOnScroll>
            <div className="max-w-3xl mx-auto px-4">
                ...
                <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-0.5 transition-all">
                    <p className="text-gray-300 mb-6">Write about me here.</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
                    ...
                    <ul className="list-disc list-inside text-gray-300 space-y-3">
                        ...
                        <li>
                            Relevent Corsework: not really any
                        </li>
                    </ul>
                </div>
                <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
                    ...
                    <div className="space-y-4 text-gray-300">
                        <div>
                            <h4 className="font-semibold"><strong>Job Name</strong> - Company (xxxx-xxxx)</h4>
                            <p>Developed and did something interesting.</p>
                        </div>
                        <div>
                            <h4 className="font-semibold"><strong>Job Name</strong> - Company (xxxx-xxxx)</h4>
                            <p>Developed and did something interesting.</p>
